	...
	return (
		...
		>
			...
			<a className={`${styles.item} ${styles.social}`} target="_blank" rel="noreferrer noopener" href="https://twitter.com/LizzyReborn">
				<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-twitter">
			...
			<a className={`${styles.item} ${styles.social}`} target="_blank" rel="noreferrer noopener" href="https://twitch.tv/LizAinslie">
				<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-twitch">
